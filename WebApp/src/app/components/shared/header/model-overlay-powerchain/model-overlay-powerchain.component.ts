...
@Component({
  ...
  templateUrl: './model-overlay-powerchain.component.html',
  styleUrls: ['./model-overlay-powerchain.component.scss'],
})

export class ModelOverlayPowerchainComponent implements OnInit {
  ShowLoader: any;
